...
<html lang="en">
  ...
  <body class="h-screen">
    ...
    <section class="relative h-[500px]">
      <img
        class="absolute route0 h-[500px] object-cover z-10 object-center w-screen"
        alt="hero"
      ...
      />
      <img
        class="absolute route1 h-[500px] object-cover z-10 object-center w-screen"
        alt="hero"
      ...
      />
      <img
        class="absolute route2 h-[500px] object-cover z-10 object-center w-screen"
        alt="hero"
      ...
      />
      <img
        class="absolute route3 h-[500px] object-cover z-10 object-center w-screen"
        alt="hero"
      ...
      />
      <img
        class="absolute route4 h-[500px] object-cover z-10 object-center w-screen"
        alt="hero"
      ...
      />
      <img
        class="absolute route5 h-[500px] object-cover z-10 object-center w-screen"
        alt="hero"
      ...
      />
      <img
        class="absolute route6 h-[500px] object-cover z-10 object-center w-screen"
        alt="hero"
      ...
      />
      <img
        class="absolute route7 h-[500px] object-cover z-10 object-center w-screen"
        alt="hero"
      ...
      />
      <img
        class="absolute route8 h-[500px] object-cover z-10 object-center w-screen"
        alt="hero"
      ...
      />
      <img
        class="absolute route9 h-[500px] object-cover z-10 object-center w-screen"
        alt="hero"
      ...
      />
      <div class="absolute h-[500px] w-screen flex items-center justify-center z-20 p-5 mt-[200px]">
        <div class="bg-blue-900 p-6 rounded-3xl">
    ...
    <script defer>
      // Hero Slide Animations - Start
      var slide1 = document.getElementsByClassName('route1')
      var slide2 = document.getElementsByClassName('route2')
      var slide3 = document.getElementsByClassName('route3')
      var slide4 = document.getElementsByClassName('route4')
      var slide5 = document.getElementsByClassName('route5')
      var slide6 = document.getElementsByClassName('route6')
      var slide7 = document.getElementsByClassName('route7')
      var slide8 = document.getElementsByClassName('route8')
      var slide9 = document.getElementsByClassName('route9')

      var tl = new TimelineLite()

      tl.from(slide1, 8, { autoAlpha: 0, ease: Power4.easeIn })
        .from(slide2, 8, { autoAlpha: 0, ease: Power4.easeIn })
        .from(slide3, 8, { autoAlpha: 0, ease: Power4.easeIn })
        .from(slide4, 8, { autoAlpha: 0, ease: Power4.easeIn })
        .from(slide5, 8, { autoAlpha: 0, ease: Power4.easeIn })
        .from(slide6, 8, { autoAlpha: 0, ease: Power4.easeIn })
        .from(slide7, 8, { autoAlpha: 0, ease: Power4.easeIn })
        .from(slide8, 8, { autoAlpha: 0, ease: Power4.easeIn })
        .from(slide9, 8, { autoAlpha: 0, ease: Power4.easeIn })
      // Hero Slide Animations -End
